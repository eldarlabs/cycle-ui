...
export function CardActions(sources, props?, children?): CycleDomComponent {
...
function makeCardActions(sources: any, props$: Observable<CardActionsProps>, children): CycleDomComponent {
